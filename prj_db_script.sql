...
INSERT INTO `esit`.`Customer` (`customerId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `enbridgeNum`) VALUES (2, 'Klever', 'Loza Vega', 'klever@esit.com', '', '647-238-5564', '1237687612');
INSERT INTO `esit`.`Customer` (`customerId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `enbridgeNum`) VALUES (3, 'Oleksandr', 'Zhurbenko', 'alex@esit.com', '', '416-152-9911', '8723772636');
INSERT INTO `esit`.`Customer` (`customerId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `enbridgeNum`) VALUES (4, 'Emile', 'Ohan', 'emile.ohan@esit.com', '', '', '2263774929');
INSERT INTO `esit`.`Customer` (`customerId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `enbridgeNum`) VALUES (5, 'Mohamed', 'Kassim', 'mohamed.kassim@esit.com', '', '', '1237792888');
...
START TRANSACTION;
USE `esit`;
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`) VALUES (1, 1, 3, 2, NULL, NULL, '2016-09-20', '2016-09-22 08:00:00', 'Won\'t be available next week', 'In Progress');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`) VALUES (2, 3, 6, 1, NULL, NULL, '2016-09-12', '2016-09-23 11:00:00', 'Can\'t do any work after 6:00 PM', 'Completed');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`) VALUES (3, 2, 8, 3, NULL, NULL, '2016-10-21', '2016-10-23 09:00:00', 'Wants to see the presentation first', 'In Progress');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`) VALUES (4, 5, 3, 1, NULL, NULL, '2016-09-15', '2016-09-28 10:30:00', 'Changed their mind', 'Cancelled');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`) VALUES (5, 4, 6, 3, NULL, NULL, '2016-09-01', '2016-09-29 10:30:00', '', 'Error');
...
START TRANSACTION;
USE `esit`;
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`) VALUES (1, 4, 3, '', '2016-09-29 10:30:00', 'Completed', 'Everything went fine');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`) VALUES (2, 5, 2, NULL, '2016-11-01 09:30:00', 'In Progress', 'Customer lives in the garage, there is no pipes');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`) VALUES (3, 7, 4, NULL, '2016-10-02 10:30:00', 'Cancelled', 'Customer changed his mind');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`) VALUES (4, 5, 1, NULL, '2016-12-12 11:00:00', 'In Progress', 'Needs more work than expected');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`) VALUES (5, 4, 5, NULL, '2016-10-05 11:30:00', 'Completed', 'Customer is happy');
