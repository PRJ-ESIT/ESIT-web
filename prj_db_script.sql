...
START TRANSACTION;
USE `esit`;
INSERT INTO `esit`.`Employee` (`employeeId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `hireDate`, `isActive`, `password`, `role`, `addressId`) VALUES (1, 'administrator', 'administrator', 'administrator@esit.com', '647-244-7718', '647-244-7718', '2016-10-19', true, 'admin_password', 'admin', NULL);
INSERT INTO `esit`.`Employee` (`employeeId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `hireDate`, `isActive`, `password`, `role`, `addressId`) VALUES (2, 'Todd', 'Burgess', 'todd@filterbutler.com', '647-625-8277', '647-625-8277', '2016-10-19', true, 'todd_password', 'manager', NULL);
INSERT INTO `esit`.`Employee` (`employeeId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `hireDate`, `isActive`, `password`, `role`, `addressId`) VALUES (3, 'Thyrone', 'Cameron', 'thyrone@filterbutler.com', '905-621-1225', '905-621-1225', '2016-10-19', true, 'thyron_password', 'salesperson', NULL);
INSERT INTO `esit`.`Employee` (`employeeId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `hireDate`, `isActive`, `password`, `role`, `addressId`) VALUES (4, 'Nazeem', 'Mohammed', 'nazeem@filterbutler.com', '416-121-9928', '416-121-9928', '2016-10-19', true, 'nazeem_password', 'installer', NULL);
INSERT INTO `esit`.`Employee` (`employeeId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `hireDate`, `isActive`, `password`, `role`, `addressId`) VALUES (5, 'Ivan', 'Medunic', 'ivan@filterbutler.com', '647-627-4411', '647-627-4411', '2016-10-19', true, 'ivan_password', 'installer', NULL);
INSERT INTO `esit`.`Employee` (`employeeId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `hireDate`, `isActive`, `password`, `role`, `addressId`) VALUES (6, 'Daniel', 'MacDonald', 'daniel@filterbutler.com', '905-819-4371', '905-819-4371', '2016-10-19', true, 'daniel_password', 'salesperson', NULL);
INSERT INTO `esit`.`Employee` (`employeeId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `hireDate`, `isActive`, `password`, `role`, `addressId`) VALUES (7, 'Chad', 'Pilkey', 'chad@filterbutler.com', '416-647-2318', '416-647-2318', '2016-10-19', true, 'chad_password', 'installer', NULL);
INSERT INTO `esit`.`Employee` (`employeeId`, `firstName`, `lastName`, `email`, `homePhone`, `cellPhone`, `hireDate`, `isActive`, `password`, `role`, `addressId`) VALUES (8, 'Danny', 'Perrone', 'danny@filterbutler.com', '416-285-1584', '416-285-1584', '2016-10-19', true, 'danny_password', 'salesperson', NULL);
