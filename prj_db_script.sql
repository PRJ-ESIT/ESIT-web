...
-- Schema esit
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `esit` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `esit` ;
...
INSERT INTO `esit`.`Program` (`programId`, `programName`, `description`, `price`) VALUES (2, 'Whole Home D-Scaler', 'D-Scaler + Bottling Kit', 34.95);
...
START TRANSACTION;
USE `esit`;
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (1, 1, 3, 2, NULL, NULL, '2016-09-20', '2016-09-22 08:00:00', 'Won\'t be available next week', 'Finished', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (2, 3, 6, 1, NULL, NULL, '2016-09-12', '2016-09-23 11:00:00', 'Can\'t do any work after 6:00 PM', 'Finished', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (3, 2, 8, 3, NULL, NULL, '2016-10-21', '2016-10-23 09:00:00', 'Wants to see the presentation first', 'Finished', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (4, 5, 3, 1, NULL, NULL, '2016-09-15', '2016-09-28 10:30:00', 'Changed their mind', 'Finished', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (5, 4, 6, 3, NULL, NULL, '2017-01-01', '2016-09-29 10:30:00', '', 'Cancelled', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (6, 1, 3, 1, NULL, NULL, '2017-01-02', '2017-09-29 10:30:00', '', 'Created', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (7, 2, 6, 2, NULL, NULL, '2017-01-03', '2017-09-28 10:30:00', NULL, 'Signed', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (8, 3, 8, 3, NULL, NULL, '2017-01-04', '2017-10-23 09:00:00', NULL, 'Paid', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (9, 4, 3, 1, NULL, NULL, '2017-01-05', '2017-09-23 11:00:00', NULL, 'Created', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (10, 1, 6, 1, NULL, NULL, '2017-01-06', '2017-01-11 11:00:00', NULL, 'Finished', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (11, 2, 8, 2, NULL, NULL, '2017-01-02', '2017-01-15 11:00:00', NULL, 'Finished', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (12, 3, 3, 3, NULL, NULL, '2017-01-03', '2017-01-20 11:00:00', NULL, 'Finished', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (13, 4, 6, 1, NULL, NULL, '2017-01-04', '2017-01-30 11:00:00', NULL, 'Finished', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (14, 5, 8, 2, NULL, NULL, '2017-01-05', '2017-01-25 11:00:00', NULL, 'Finished', NULL, '16408400609');
INSERT INTO `esit`.`Sale` (`saleId`, `customer`, `salesRepId`, `program`, `rentalAgreement`, `PADForm`, `dateSigned`, `installationDateTime`, `notes`, `status`, `envelopeId`, `folderId`) VALUES (15, 1, 3, 3, NULL, NULL, '2017-01-07', '2017-01-28 11:00:00', NULL, 'Finished', NULL, '16408400609');
...
START TRANSACTION;
USE `esit`;
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`, `envelopeId`, `folderId`) VALUES (1, 4, 3, '', '2016-09-29 10:30:00', 'Completed', 'Everything went fine', NULL, '16408400609');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`, `envelopeId`, `folderId`) VALUES (2, 5, 2, NULL, '2016-11-01 09:30:00', 'Completed', 'Customer lives in the garage, there is no pipes', NULL, '16408400609');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`, `envelopeId`, `folderId`) VALUES (3, 7, 4, NULL, '2016-10-02 10:30:00', 'Cancelled', 'Customer changed his mind', NULL, '16408400609');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`, `envelopeId`, `folderId`) VALUES (4, 5, 1, NULL, '2016-12-12 11:00:00', 'Completed', 'Needs more work than expected', NULL, '16408400609');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`, `envelopeId`, `folderId`) VALUES (5, 4, 5, NULL, '2016-10-05 11:30:00', 'Completed', 'Customer is happy', NULL, '16408400609');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`, `envelopeId`, `folderId`) VALUES (6, 5, 10, NULL, '2017-01-15 11:30:00', 'Scheduled', NULL, NULL, '16408400609');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`, `envelopeId`, `folderId`) VALUES (7, 7, 11, NULL, '2017-01-25 11:30:00', 'Documented', NULL, NULL, '16408400609');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`, `envelopeId`, `folderId`) VALUES (8, 5, 12, NULL, '2017-01-20 11:30:00', 'Installed', NULL, NULL, '16408400609');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`, `envelopeId`, `folderId`) VALUES (9, 4, 13, NULL, '2017-01-17 11:30:00', 'Customer signed', NULL, NULL, '16408400609');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`, `envelopeId`, `folderId`) VALUES (10, 7, 14, NULL, '2017-01-18 11:30:00', 'Installer signed', NULL, NULL, '16408400609');
INSERT INTO `esit`.`Installation` (`installationId`, `installer`, `sale`, `installationCert`, `installationDateTime`, `status`, `notes`, `envelopeId`, `folderId`) VALUES (11, 4, 15, NULL, '2017-01-29 11:30:00', 'Scheduled', NULL, NULL, '16408400609');
